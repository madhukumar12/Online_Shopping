						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<sf:textarea path="description" id="description" rows="4"
									placeholder="Enter the description here" class="form-control" />
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<sf:input type="number" path="quantity" id="quantity"
									placeholder="Quantity availbe" class="form-control" />
							</div>
						</div>
					...
					<sf:form id="categoryForm" modelAttribute="category"
						...
						<div class="form-group">
							<label for="category_description" class="control-label col-md-4">Category
								Description</label>
							<div class="col-md-8">
								<sf:input cols="" rows="5" type="text" path="description"
